...
export default function RegisterPage() {
  ...
  // --- Lógica del Validador de Contraseña ---
  ...
  // 2. Extraer días según horario elegido
  useEffect(() => {
    if (!form.horarioId) {
      setDiasHorario([]);
  ...
  const formValid = Object.keys(errors).length === 0 && passwordStrength >= 3;
          ...
          <div className="card--glass">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select id="tipo" name="tipo" value={form.tipo} className="auth-select" onChange={handleChange}>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input id="nombre" name="nombre" value={form.nombre} className="auth-input" onChange={handleChange} />
                  {errors.nombre && <small className="error-text">{errors.nombre}</small>}
                </div>
                <div className="form-group">
                  <label htmlFor="apellido_paterno">Apellido paterno</label>
                  <input id="apellido_paterno" name="apellido_paterno" value={form.apellido_paterno} className="auth-input" onChange={handleChange} />
                  {errors.apellido_paterno && <small className="error-text">{errors.apellido_paterno}</small>}
                </div>
                <div className="form-group">
                  <label htmlFor="apellido_materno">Apellido materno</label>
                  <input id="apellido_materno" name="apellido_materno" value={form.apellido_materno} className="auth-input" onChange={handleChange} />
              ...
              <div className="form-group">
                ...
                <input id="email" name="email" type="email" value={form.email} className="auth-input" onChange={handleChange} />
              ...
              {form.tipo === "estudiante" && (
                <>
                  <div className="form-group">
                    ...
                    <select id="division" name="division" value={form.division} className="auth-select" onChange={handleChange}>
                  ...
                  <div className="form-group">
                    ...
                    <select id="carrera" name="carrera" value={form.carrera} className="auth-select" onChange={handleChange}>
              ...
              <div className="form-group">
                ...
                <select id="horarioId" name="horarioId" value={form.horarioId} className="auth-select" onChange={handleChange}>
              ...
              {/* Password con Validador corregido */}
              <div className="form-group">
                ...
                <input
                  ...
                  name="password"
                  type="password"
                  value={form.password} // 👈 Agregado para que funcione el validador
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  type="password"
                  value={form.confirmPassword} // 👈 Agregado para que React lo controle
                  className="auth-input"
